...
<h1 class="absolute inset-0 flex items-center justify-left text-5xl font-bold text-center ml-20 mt-20 text-white">Your Reservation,<br> Our Priority</h1>
        ...
        <button onclick="document.getElementById('register_modal').showModal()" style="margin-left: 190px; margin-top: 550px;" class="btn wave-effect mb-40 absolute inset-0   w-40 h-15 m-auto bg-green-700 text-white rounded-2xl hover:bg-green-800">Purchase Now</button>
                    ...
                    <div class="flex items-center space-x-4 p-10 w-max">
                        <a href="dfap.php?lot_type=Socialized (Low Cost)&lot_area=no size&amount=₱18,000.00&down=P5,000.00&id=1">
                            <button class="container bg-white p-6 rounded-lg shadow-lg w-64">
                                ...
                                <div class="item">
                                    ...
                                    <span class="text-gray-700">NO. Available:</span>
                                ...
                                <div class="item mb-4">
                                    <p class="text-gray-600">
                                    <span class="text-gray-700">Lot Area Size (Sq m): no size</span>
                        ...
                        <a href="dfap.php?lot_type=Socialized&lot_area=Size (Sq m): 2.44&amount=₱29,000.00&down=P5,000.00&id=2">
                            <button class="container bg-white p-6 rounded-lg shadow-lg w-64">
                                ...
                                <div class="item mb-4">
                                    <p class="text-gray-600">
                                    <span class="text-gray-700">Lot Area Size (Sq m): 2.44</span><br>
                        ...
                        <a href="dfap.php?lot_type=Lawn Lot&lot_area=Upgraded&amount=₱57,000.00&down=P5,000.00&id=4">
                            <button class="container bg-white p-6 rounded-lg shadow-lg w-64">
                                ...
                                <div class="item mb-4">
                                    <p class="text-gray-600">
                                    <span class="text-gray-700"><b> Upgraded</b></span><br>
                        ...
                        <a href="dfap.php?lot_type=4-Lot Garden&lot_area=Size (Sq m): 9.76&amount=₱185,000.00&down=P20,000.00&id=5">
                            <button class="container bg-white p-6 rounded-lg shadow-lg w-64">
                                ...
                                <div class="item mb-4">
                                    <p class="text-gray-600">
                                    <span class="text-gray-700">Lot Area Size (Sq m): 9.76</span><br>
