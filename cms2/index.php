...
<button onclick="document.getElementById('register_modal').showModal()" style="margin-left: 190px; margin-top: 470px;" class="btn wave-effect absolute inset-0   w-40 h-15 m-auto bg-green-700 text-white rounded-2xl hover:bg-green-800">Purchase Now</button>
