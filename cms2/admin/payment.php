...
<?php 
          ...
          $query = "
          SELECT 
              users.username, reservations.first_name, reservations.middle_name, reservations.last_name, 
              reservations.lot_type, reservations.amount, reservations.reservation_date, 
              reservations.area_size, reservations.down_payment, reservations.monthly_amortization 
          FROM 
              reservations 
          JOIN 
              users 
          ...
          $reservations = $db->selectWithWhere($query);
          foreach($reservations_users as $p){
            extract($p);
          ?>
          <tr class="hover:bg-gray-100">
